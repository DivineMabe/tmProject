...
// and having as a subject something like "Your DaDaBIK 11.9 Elba ENTERPRISE File Download"
...
$languages_ar = array ('english','italian','catalan','chinese','croatian','czech','danish','dutch','estonian','finnish','french','german','hungarian','norwegian','polish','portuguese','rumanian','russian','slovak','spanish','swedish','telugu');
...
$grant_permissions_autoincrement_after_table_installation = 1;
...
///////////////////////////////////////////////////////////////////////////////////////////////
// ...
// IMPORT SYNCH is available for DaDaBIK Platinum only
...
// $upload_directory is the absolute path (e.g. /users/john/dadabik/uploads/) of the directory where the files you upload with DaDaBIK (for generic_file and image_file field types) are finally stored.
...
// The results grid, for each row, shows the edit, delete and details icons. Starting from V 11.2, those icons by default are Font Awesome icons. You can set this parameter to 'images' if, instead, you still want to use images (e.g. a png file)  ('font_awesome','images')
$edit_delete_details_icons_type = 'font_awesome';

// Font Awesome icons or image files to use as icons for delete, edit, details, file
// Both Font Awesome 4 and 5 are supported; if instead, you chose 'images' for $edit_delete_details_icons_type you can speficy here the files using their absolute or relative path (e.g. 'images/delete.png')
$delete_icon = 'far fa-trash-alt fa-lg';
$edit_icon = 'far fa-edit fa-lg';
$details_icon = 'fas fa-info-circle fa-lg';
$file_icon = 'fas fa-paperclip fa-lg';

// colors of the icons (only if you are using Font Awesome icons)
$delete_icon_color = '#d3323a';
$edit_icon_color = 'gray';
$details_icon_color = 'gray';
...
///////////////////////////////////////////////////////////////////////////////////////////////
// ...
// Revisions/Autid is available for DaDaBIK Platinum only
