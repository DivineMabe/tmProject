...
if (isset($custom_buttons) && count($custom_buttons) > 0){
    foreach ($custom_buttons as $buttons_table){
        ...
        foreach ($buttons_table as $button){
            ...
            echo '<p> <input type="button" class="button_form custom_button" style="'.$button['style'].'" value="'.$button['label'].'"> <b>Callback function:</b> '.$button['callback_function'].' <b>code type:</b> '.$button['type'];
