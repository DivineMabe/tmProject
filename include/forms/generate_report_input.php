...
echo $normal_messages_ar['simple_report'];
...
echo $normal_messages_ar['advanced_sql_report'];
...
<div class="select_element" style="display:inline-block;vertical-align: middle" ><select name="report_type" onchange="show_hide_report_options(this.value)">
...
<div id="date_functions_container" class="select_element"  style="display:inline-block;vertical-align: middle"><select name="date_function" id="date_function">
...
<div class="select_element"  style="display:inline-block;vertical-align: middle"><select name="group_by_field" id="group_by_field"  onchange="show_hide_date_functions_select();">
...
<div class="select_element select_element_100px" style="display:inline-block;vertical-align: middle"><select name="group_by_operator" onchange="show_hide_report_value_field_option(this.value,1)">
...
<div class="select_element" style="display:none;vertical-align: middle" id="report_value_field_option_2"><select name="report_value_field">
<?php
...
?>
<a class="add_remove_column" data-targetid="2" data-function="add" href="">[<?php echo $normal_messages_ar['add_column']; ?>]</a> <br>
...
<div class="select_element select_element_100px"    style="display:inline-block;vertical-align: middle"><select  <?php echo $disabled_next_input; ?> name="group_by_operator_2" onchange="show_hide_report_value_field_option(this.value,2)">
...
<div class="select_element"  style="display:none;vertical-align: middle" id="report_value_field_option_2_2"><select name="report_value_field_2" >
<?php
foreach($report_value_fields_ar as $key => $value){ 
...
<a class="add_remove_column" data-targetid="3" data-function="add" href="">[<?php echo $normal_messages_ar['add_column']; ?>]</a> <a class="add_remove_column" data-targetid="2" data-function="remove" href="">[<?php echo $normal_messages_ar['remove_this_column']; ?>]</a> <br>
...
<div class="select_element select_element_100px"    style="display:inline-block;vertical-align: middle"><select  <?php echo $disabled_next_input; ?> name="group_by_operator_3" onchange="show_hide_report_value_field_option(this.value,3)">
...
<div class="select_element"  style="display:none;vertical-align: middle" id="report_value_field_option_2_3"><select name="report_value_field_3" >
<?php
foreach($report_value_fields_ar as $key => $value){ 
...
<a class="add_remove_column" data-targetid="4" data-function="add" href="">[<?php echo $normal_messages_ar['add_column']; ?>]</a> <a class="add_remove_column" data-targetid="3" data-function="remove" href="">[<?php echo $normal_messages_ar['remove_this_column']; ?>]</a> <br>
...
<div class="select_element select_element_100px"    style="display:inline-block;vertical-align: middle"><select  <?php echo $disabled_next_input; ?> name="group_by_operator_4" onchange="show_hide_report_value_field_option(this.value,4)">
...
<div class="select_element"  style="display:none;vertical-align: middle" id="report_value_field_option_2_4"><select name="report_value_field_4" >
<?php
foreach($report_value_fields_ar as $key => $value){ 
...
<a class="add_remove_column" data-targetid="5" data-function="add" href="">[<?php echo $normal_messages_ar['add_column']; ?>]</a> <a class="add_remove_column" data-targetid="4" data-function="remove" href="">[<?php echo $normal_messages_ar['remove_this_column']; ?>]</a> <br>
...
<div class="select_element select_element_100px"    style="display:inline-block;vertical-align: middle"><select  <?php echo $disabled_next_input; ?> name="group_by_operator_5" onchange="show_hide_report_value_field_option(this.value,5)">
...
<div class="select_element"  style="display:none;vertical-align: middle" id="report_value_field_option_2_5"><select name="report_value_field_5" >
<?php
foreach($report_value_fields_ar as $key => $value){ 
...
?>
 ...
 <a class="add_remove_column" data-targetid="5" data-function="remove" href="">[<?php echo $normal_messages_ar['remove_this_column']; ?>]</a> <br>
...
<br/>
<input class="button_form"  type="submit" value="<?php echo $normal_messages_ar[$submit_label]; ?> >>"> <a class="btn btn-primary" href="<?php echo $dadabik_main_file; ?>?function=search&tablename=<?php echo urlencode($table_name); ?>"> <?php echo $submit_buttons_ar['go_back']; ?></a>
