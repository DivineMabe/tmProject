...
$normal_messages_ar = array (
	...
	"phone_not_valid" => "Wpisany numer telefonu jest nieprawidlowy.<br>Prosze uzyc formatu \"+(kod kraju)(kierunkowy)(numer)\" np +48711234567, 0048711234567, 711234567.",
	"date_not_valid" => "Wpisales jedna lub wiecej nieprawidlowych dat.",
	"similar_records" => "Rekordy ponizej wydaja sie podobne do tego, ktory wpisales  (I'll show max ".$number_duplicated_records." similar items, there could be more).<br>Co chcesz zrobic?", // to change
	"similar_records_short" => "Rekordy ponizej wydaja sie podobne do tego, ktory wpisales  (I'll show max ".$number_duplicated_records." similar items, there could be more).", // to change
...
$error_messages_ar = array (
	...
	"no_authorization_update" => "Nie masz uprawnien aby zmieniac rekord.",
	"no_authorization_delete" => "Nie masz uprawnien aby poprawiac rekord.",
