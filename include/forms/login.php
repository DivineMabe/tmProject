...
<tr><td align="right" style="padding: 5px;"><input type="text" name="username_user" class="input_login_form" placeholder="<?php echo $login_messages_ar['username']; ?>" ></td></tr>
<tr><td align="right" style="padding: 5px;"><input type="password" name="password_user" class="input_login_form" placeholder="<?php echo $login_messages_ar['password']; ?>" ></td></tr>
...
<input type="submit" class="login_button" value="<?php echo $login_messages_ar['login']; ?> >>"></td></tr>
