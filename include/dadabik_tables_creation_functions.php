...
function create_config_table($data_types = 'simple', $install_enable_tables_on_creation = 'no')
// ****************************UP
{
	...
	$sql = "INSERT INTO ".$quote.$prefix_internal_table."config".$quote." (name_config, value_config) VALUES ('data_types', '".$data_types."'), ('install_enable_tables_on_creation', '".$install_enable_tables_on_creation."'),('dont_show_menu_if_only_one_item', '0'),('graphic_theme', 'bluegray'),('grid_layout_scrolling', 'grid_scroll'),
...
// goal: drop (if present) the old static_pages table and create the new one.
{
	...
	$sql = "INSERT INTO ".$quote.$prefix_internal_table."static_pages".$quote." (enabled_static_page, link_static_page, content_static_page, type_static_page, is_homepage_static_page, href_link_static_page) VALUES (1, 'Home', '<p>Congratulations! This is the homepage of the DaDaBIK application you have created.</p>\r\n<p>If you login as administrator you can customize this application by clicking on <b>Edit this app</b><br/><br/>To change this homepage: <b>Edit this app</b> > <b>Pages</b> > <b>Show: Custom Pages</b>.</p>', 'html', 'y', '')";
