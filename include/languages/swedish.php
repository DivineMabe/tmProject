...
$error_messages_ar = array (
	...
	"no_authorization_update" => "Du är inte auktoriserad för att ändra denna datapost.",
	"no_authorization_delete" => "Du är inte auktoriserad för att radera denna datapost.",
