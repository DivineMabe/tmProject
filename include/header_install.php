...
<meta name="Generator" content="DaDaBIK 11.9 Elba - https://dadabik.com/">
...
<style>
html { 
<?php if (!isset($_POST['install']) || $_POST['install'] == 1 || $_POST['install'] == 2 || $_POST['install'] == 5){ ?>
  background: url(https://dadabik.com/get_pic.php) no-repeat center center fixed;
<?php } ?>
...
<div style="background-color:white;text-align:left"><img src="images/logo.png" class="logo_installation"></div>