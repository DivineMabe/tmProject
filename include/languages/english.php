...
'no_pdf_template' => 'No PDF template',
...
'possible_duplication_continue_to_update' => 'Possible duplication, some elements have the same values on the unique fields (the duplication could also be within your file). Here are the duplicated elements. At the moment no elements have been inserted or updated. If you click "Continue" at the end of hte page, for these elements, I will update the records with the new information provided in the file. ',
...
'to_verify_elements_click_continue_filter_set' => 'To verify the elements inserted/updated click on "Continue". I have set a search filter that allows you to see only the inserted/updated elements (you could see only some of them if the administrator set additional filters).',
'no_element_has_been_inserted' => 'No element has been inserted.',
'error_no_sheet_with_name'=> 'Error, no sheet with name:',
'elements_results_last_import' => 'The elements you see are the result of the last import (you could see only some of them if the administrator set additional filters). To see all the elments click on "Remove reseaerch filter"',
