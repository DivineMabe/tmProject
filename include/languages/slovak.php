...
$normal_messages_ar = array (
	...
	"phone_not_valid" => "Telefonne cislo nie je platne.<br>Prosim, pouzi format \"+(kod tatu)(kod oblasti)(cislo)\"  napr. +4210523599318, 004210523599318, 10523599318.",
	"date_not_valid" => "Vlozil si jeden alebo viac nespravnych datumov.",
	"similar_records" => "Zaznam sa zda byt podobny uz zapisanemu udaju (I'll show max ".$number_duplicated_records." similar items, there could be more).<br>Co chces urobit?",// to change
	"similar_records_short" => "Zaznam sa zda byt podobny uz zapisanemu udaju (I'll show max ".$number_duplicated_records." similar items, there could be more).",// to change
...
$error_messages_ar = array (
	...
	"no_authorization_update" => "Nemas opravnenie zmenit tento zaznam.",
	"no_authorization_delete" => "Nemas opravnenie vymazat tento zaznam.",
