...
{
	global $debug_mode, $dbms_type, $db_schema, $sqlserver_conn_additional_attributes, $disable_mysql_multiple_statements, $page_name;
...
{
	global $debug_mode, $dbms_type, $use_unicode_sqlserver_transformations, $unicode_sqlserver_transformations;
...
function execute_prepared_db($res_prepare, $return_control_on_error = 0)
{
	global $debug_mode;
    ...
    try {
    	$res_execute = $res_prepare->execute();
    }
    catch(PDOException $e){
    	if ($return_control_on_error === 1){
